...
/**
 * Clase Critica
 * Esta clase maneja la información necesario sobre la crítica de un espectáculo.
...
public class Critica {
	 ...
	 * Los valores válidos son de 1 a 10, siendo el 1 la puntuación menor.
	 * No puede ser NULL.
	 */
	 ...
	 * Lista con todas las valoraciones que ha recibido la crítica.
	 * Los valores válidos son de 1 a 5, siendo el 1 la valoración menor.
	 */
	private ArrayList<Integer> valoraciones;
	
	/**
	 * Correo eléctronico del espectador que escribe la crítica
	 */
	 ...
	 * @param puntuacion Puntuación del espectáculo.
	 * @param reseña Comentario sobre el epsectáculo.
	 * @param valoraciones Valoraciones de la crítica.
	 */
	public Critica(String titulo, int puntuacion, String reseña, ArrayList<Integer> valoraciones) {
		super();
		this.titulo = titulo;
	 ...
	 * @param valoracion Valoraciones de la crítica.
	 * @return Nada.
	 */
	...
	/**
	 * Este método devuelve el correo eléctronico del espectador que escribió la crítica
	 * @return Correo eléctronico del espectador que escribe la crítica
	 */
	...
	/**
	 * Este método asigna el correo eléctronico del espectador que escribió la crítica
	 * @param correo Correo eléctronico del espectador que escribe la crítica
	 * @return Nada.
	 */
