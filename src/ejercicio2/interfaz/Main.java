...
public class Main {
	...
	public static void main(String[] args) {
		...
		int opcionInicio = 0, opcion = 0, tipo = 0, numero = 0, subtipo = 0;
								...
								if(numero == 1){
									...
									if (gestorcriticas.comprobarFormatoCorreo(correo)) {
										if (!gestorcriticas.correoRegistrado(correo)) {
											...
											gestorcriticas.altaUsuario(nombre, apellidos, nick, correo, contrasena, tipoUsuarioRegistro);
										} else {
					...
					do{
						...
						switch(opcion){
							...
							case 2:
								...
								switch(tipo){
									case 1:
										//cancelar todas las sesiones de un espectaculo (ESPECTACULO DE PASE MULTIPLE)
										gestorespectaculos.Cancelarespectaculotodos(titulo);
										break;
										
									case 2:
										//cancelar una sesion de un espectaculo - sesion se refiere a fecha y hora
										//gestorespectaculos.Cancelarespectaculosesion(titulo, sesion);
										break;
								}
								break;
							...
							case 5:
								//Consultar localidades disponibles de un espectaculo
								break;
							...
							case 10:
								//Eliminar critica de un espectaculo (solo el propietario de la critica)
								System.out.println("Introduzca el titulo del espectaculo: ");
								titulo = reader.nextLine();
								buffer = gestorespectaculos.Consultarcriticas(titulo);
								System.out.println(buffer);
